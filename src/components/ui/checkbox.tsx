...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        // @radix-ui/react-checkbox v1.x sets data-state="checked"/"unchecked".
        // shadcn v4 generated data-checked: variants target Radix v2's data-checked
        // attribute, which doesn't exist in v1. Use data-[state=checked]: instead.
